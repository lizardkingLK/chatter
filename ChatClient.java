...
public class ChatClient {
    ...
    // TODO: Add a list box
    DefaultListModel<String> limodel = new DefaultListModel<>();
    JList<String> namelist = new JList<>(limodel);
    ...
    public ChatClient() {
        ...
        frame.getContentPane().add(namelist,"South");
            ...
            public void actionPerformed(ActionEvent e) {
            	if(check || namelist.isSelectionEmpty()) {
            		...
            		for(int i=0;i<namelist.getModel().getSize();i++) {
            			Object item = namelist.getModel().getElementAt(i);
    ...
    private void run() throws IOException {
        ...
        while (true) {
            ...
            if (line.startsWith("SUBMITNAME")) {
            	...
            	limodel.addElement(line.substring(4));
            } else if (line.startsWith("EXIT")) {
            	limodel.remove(limodel.indexOf(line.substring(4)));
            }
        }
    }
